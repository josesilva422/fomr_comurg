...
>
> **EDITAL PUBLICADO (Nº 001/2026, 28/09/2026), recebido em 24/09/2026 — é a versão que vale e substitui a minuta de 22/09** (arquivo em `docs/`). Datas: publicação **28/09**; inscrições **28/09 a 13/10**; cronograma de 24 itens (Anexo IV) em `interno.cronograma`. Mudanças de regra em relação à minuta de 22/09: ver D21 e N9 em `docs/decisoes-pendentes.md` (isenção paga até 16/10 se indeferida — 4.10.2; diploma digital com qualquer mecanismo oficial — 5.1.2; recursos por e-mail — 9.2; reservas PcD/negros e heteroidentificação — 10.1/10.2; cadastro de reserva 3 por vaga — 11.1). As datas da tabela da seção 3 abaixo são as da minuta de 22/09 e estão **desatualizadas**: valem as de `interno.cronograma`.
>
