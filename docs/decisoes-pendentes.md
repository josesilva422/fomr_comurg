...
| N6 | **Convocação para entrevista mudou de até 5 para até 3 candidatos por vaga** (edital atualizado 22/09/2026, item 6.5.1) | Ainda não implementado (Fase 3/4) | Usar "3" quando a tela de convocação for construída |
| N7 | **Cronograma de entrevistas/recursos/resultado final antecipado** (edital atualizado 22/09/2026, Anexo IV): entrevistas agora `03/11 a 12/11` (era `03/11 a 28/11`), resultado final `até 25/11` (era `11/12`), convocações `a partir de 26/11` (era `12/12`). Inscrições (`24/09 a 07/10`) não mudaram. | Ainda não implementado (Fase 3/4) | Usar as novas datas quando essas telas forem construídas; ver CLAUDE.md seção 3 |
