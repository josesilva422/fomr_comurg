    ...
    <div className="card">
      <header className="step-head">
        ...
        <p className="lead">
          ...
          e os candidatos cujas fichas de entrevista técnica foram lançadas por cada avaliador. O cadastro e a desativação de usuários são feitos direto no banco.
        </p>
      </header>
      <UsuariosLista />
    </div>
