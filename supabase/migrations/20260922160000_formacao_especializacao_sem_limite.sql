-- Edital atualizado (nova minuta recebida em 22/09/2026, arquivo "Minuta_Edital_PSS_COMURG_2026_v2 - 22-09-2026-08-07.docx"):
-- Anexo I, item 1 (Formação Acadêmica Adicional) mudou a regra da Especialização/MBA.
--
--   ANTES: 2,0 pts por título, até 6,0 pts (máx. 3 títulos).
--   AGORA: 2,0 pts por título, "sem limite de quantidade" — só respeita o teto global do critério (10,0 pts),
--          que já é compartilhado com mestrado (3,0, máx. 1) e doutorado (4,0, máx. 1) e já era aplicado no
--          motor (clamp de pontos_formacao a 10 ao final do laço). Mestrado e doutorado NÃO mudaram.
--
-- O novo texto do edital traz até uma tabela de exemplos que confirma a leitura (5 especializações = 10,0 pts,
-- exatamente o teto; 6 ou mais = ainda 10,0, capado pelo teto global, não por um limite de contagem).
--
-- Reversão: supabase/rollback/20260922160000_formacao_especializacao_sem_limite.down.sql
