-- Restaura o estado da migração 20260922140000: sem coluna "bloqueia", título/curso sem documento volta a
-- bloquear o envio, e o motor de pontuação volta a não checar anexo de documento.
